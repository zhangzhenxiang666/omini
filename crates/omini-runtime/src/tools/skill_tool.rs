...
impl Tool for SkillTool {
    ...
    fn description(&self) -> &str {
        concat!(
            ...
            "absolute skill directory for bundled resources. If the current user message already ",
            "contains a <skill> block for the same skill with <source>slash_command</source>, ",
            "follow the included skill body instead of calling this tool again."
        )
    }
